...
//   repeat: -1
// });
(0, _gsapDefault.default).set(".clients__img-wrap", {
    x: (i)=>i * 50
});
(0, _gsapDefault.default).to(".clients__img-wrap", {
    duration: 5,
    ease: "none",
    x: "-=500",
    modifiers: {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4qavH","8ZNvh"], "8ZNvh", "parcelRequire94c2")
